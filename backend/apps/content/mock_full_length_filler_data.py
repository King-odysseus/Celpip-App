...
LISTENING_FILLER_SETS = [
    _set(
        ...
        "Priya: Hi, I think I left a green umbrella in the lobby yesterday evening. Has anyone turned one in?\nSam: Let me check the lost-and-found bin. Yes, we have a green umbrella here with a wooden handle.\nPriya: That's the one. Can I pick it up now, or do I need to show anything?\nSam: You can take it right away, since you already described the colour and handle correctly.\nPriya: Great, thank you. I was worried I had left it on the bus instead.\nSam: It happens often. We usually hold items here for about a month before donating them.\nPriya: Good to know. I will check with you sooner next time if I misplace something else.",
        [
    ...
    _set(
        ...
        "Owen: I borrowed one of your tablets last week. Where should I return it?\nClerk: You can drop it at this desk. Just make sure the charging cable is included.\nOwen: It is. Will you check that everything still works before I leave?\nClerk: Sure, I will turn it on and confirm the screen and battery are fine.\nOwen: Thanks. I also wanted to ask whether I can borrow a second tablet today.\nClerk: You can, as long as you have not reached the two-item borrowing limit this month.\nOwen: This would be my first this month, so that should be no problem at all.\nClerk: Perfect. I will just need to see your library card to register the new loan.\nOwen: Here it is. How long can I keep this one before it is due back?",
        [
    ...
    _set(
        ...
        "Announcer: Attention members, starting this weekend the gym will open one hour later, at nine instead of eight, to allow time for new equipment installation. Regular weekday hours are not affected, and the change will remain in place for the next three weekends only. The new equipment includes two treadmills and a set of adjustable benches for the free-weight area. Staff will be available during the extra hour each morning to answer questions about the updated layout. Members with early morning bookings should check the schedule board for any room changes. Group fitness classes will keep their usual start times once the gym floor opens. Locker rooms will remain open at the regular time for anyone who arrives early. We appreciate your patience while we improve the facility for everyone.",
        [
