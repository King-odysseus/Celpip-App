...
LISTENING_SETS = [
    {
        ...
        "speaker_genders": {"Nadia": "female", "Colin": "male"},
        "questions": [
            ...
            {"stem": "What will Nadia bring when they speak to the manager?", "skill_focus": "detail", "evidence": "I'll bring a photo of my thermostat reading.", "explanation": "Nadia wants to show the manager evidence of the cold temperature.", "choices": [c("A photo of her thermostat reading", True, "This is what she offers to bring."), c("A portable heater", False, "They discuss not buying one."), c("The maintenance recording", False, "She already heard it."), c("A copy of the building notice", False, "No copy is mentioned.")]},
        ],
    },
    {
        ...
        "questions": [
            ...
            {"stem": "Which class will Leila plan to attend?", "skill_focus": "detail", "evidence": "I'll switch to Saturday", "explanation": "Leila decides to attend the Saturday morning class.", "choices": [c("Friday evening", False, "Friday is difficult for her."), c("Saturday morning", True, "This is the class she chooses."), c("The following Tuesday", False, "No Tuesday class is mentioned."), c("She will not attend", False, "She still plans to see the demonstration.")]},
        ],
    },
    {
        ...
        "questions": [
            ...
            {"stem": "What should volunteers do if they find broken glass?", "skill_focus": "detail", "evidence": "if you find broken glass or a needle, do not pick it up. Stand nearby and call the phone number printed on your map", "explanation": "Volunteers should avoid picking up the item and call for a safety volunteer.", "choices": [c("Pick it up and place it in a bag", False, "They are told not to pick it up."), c("Leave it and call the number on the map", True, "This is the safe instruction."), c("Cover it with leaves", False, "No covering instruction is given."), c("Tell another volunteer to move it", False, "A safety volunteer should respond.")]},
        ],
    },
    {
        ...
        "questions": [
            ...
            {"stem": "How can residents book appointments for the new service?", "skill_focus": "detail", "evidence": "Appointments can be booked by phone beginning next Tuesday. A limited number of same-day spaces will also be available", "explanation": "Phone booking opens next Tuesday, with some same-day spaces.", "choices": [c("Only through the regional hospital", False, "The bus brings services closer to communities."), c("By phone beginning next Tuesday", True, "This is the stated booking method."), c("Only online after the review", False, "No online-only rule is stated."), c("By visiting the mayor's office", False, "The mayor is not a booking contact.")]},
        ],
    },
    {
        ...
        "speaker_genders": {"Marisol": "female", "Graham": "male", "Sophie": "female"},
        "questions": [
            ...
            {"stem": "What does Graham suggest asking payroll?", "skill_focus": "detail", "evidence": "We should also ask payroll whether unused credit can carry forward.", "explanation": "Graham wants to know whether unused credit can be kept for later use.", "choices": [c("Whether unused credit can carry forward", True, "This is Graham's question."), c("Whether the pass can be shared", False, "Sharing is not discussed."), c("Whether fares will rise", False, "No fare increase is discussed."), c("Whether payroll can issue cards", False, "Card issuance is not the question.")]},
        ],
    },
    {
        ...
        "questions": [
            ...
            {"stem": "How should success be measured according to the speaker?", "skill_focus": "detail", "evidence": "Success should be measured not only by attendance but also by whether different ages, incomes, and mobility levels can participate.", "explanation": "The speaker wants success to include participation by a range of people.", "choices": [c("Only by attendance numbers", False, "The speaker says not only attendance."), c("By whether diverse groups can participate", True, "Age, income, and mobility are named."), c("Only by city funding saved", False, "Funding is not the measure."), c("By how quickly projects are replaced", False, "Replacement is part of review, not the success measure.")]},
        ],
    },
]
