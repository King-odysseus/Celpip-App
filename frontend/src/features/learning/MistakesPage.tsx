...
export function MistakesPage() {
  ...
  const filtered = useMemo(() => items.filter((item) => (stateFilter === 'all' || item.state === stateFilter) && (skill === 'all' || item.skill === skill)), [items, skill, stateFilter])
